...
const getAIRecommendations = async (solvedProblems, weakTopics, allTopics, context) => {
    ...
    if (totalSolved < 5) {
        ...
        tips.push("Review your incorrect submissions and focus on understanding mistakes.");
    }
    else if (optimalCount / (totalSolved || 1) < 0.5) {
        tips.push("Aim for more optimal solutions; revisit problems where your solution was not optimal.");
    }
    else {
        tips.push("Great job! Try mock interviews and timed practice for the next level.");
    }
    return {
        weakTopics,
        suggestedProblems,
