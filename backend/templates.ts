...
export const DSA_TEMPLATES = [
  {
    ...
    category: "Searching",
    description:
      "Divide and conquer on a sorted array. Halves the search space each iteration.",
  ...
  },
  {
    ...
    category: "Arrays",
    description:
      "Maintain a window of elements and slide it across the array to compute running aggregates.",
    timeComplexity: "O(N)",
  ...
  },
  {
    ...
    category: "Arrays",
    description:
      "Use two pointers moving towards or away from each other to solve problems in O(N).",
    timeComplexity: "O(N)",
    spaceComplexity: "O(1)",
    whenToUse: [
...
vector<int> dfs(unordered_map<int, vector<int>>& graph, int start) {
  ...
  },
  {
    ...
    description:
      "Break problems into overlapping subproblems. Build solutions bottom-up or top-down.",
...
int dpTopDown(int n) {
  ...
  },
  {
    ...
    category: "Recursion",
    description:
      "Build candidates incrementally and abandon a candidate as soon as it violates constraints.",
  ...
  },
  {
    ...
    category: "Graphs",
    description:
      "Efficiently track connected components. Near O(1) union and find operations.",
...
public:
  ...
  },
  {
    ...
    description:
      "Efficiently get min/max elements. Used in top-K, merge-K, and scheduling problems.",
...
vector<int> topKLargest(vector<int>& nums, int k) {
  ...
  },
  {
    ...
    category: "Data Structures",
    description:
      "Tree structure for efficient string prefix operations. O(L) insert/search where L = word length.",
