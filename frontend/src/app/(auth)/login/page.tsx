      ...
      <div className="relative w-full max-w-[440px] flex flex-col items-center">
        ...
        <div className="mb-10 flex flex-col items-center space-y-4">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm mt-2 font-medium">Elevate your algorithmic journey</p>
          </div>
        </div>
        ...
        <div className="w-full bg-[#0d0d0d] border border-white/10 p-10 rounded-[2.5rem] shadow-2xl backdrop-blur-xl">
          <div className="space-y-8">
            <div className="text-center space-y-2">
              ...
              <p className="text-gray-500 text-sm">Sign in with your account to continue</p>
            </div>
            ...
            <div className="pt-4 grid grid-cols-3 gap-4">
              <div className="flex flex-col items-center space-y-2">
                ...
                <span className="text-[10px] uppercase tracking-widest text-gray-500 font-bold">Stats</span>
              </div>
              <div className="flex flex-col items-center space-y-2">
                <div className="p-2 rounded-lg bg-white/5 text-gray-400">
                  <Target size={16} />
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <span className="text-[10px] uppercase tracking-widest text-gray-500 font-bold">Streaks</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 flex items-center gap-6">
          <span className="text-[11px] font-bold text-gray-600 uppercase tracking-[0.2em]">Verified Secure</span>
          <div className="h-1 w-1 rounded-full bg-gray-800"></div>
          <span className="text-[11px] font-bold text-gray-600 uppercase tracking-[0.2em]">AWS Hosted</span>
        </div>
      </div>
    </div>
  );
