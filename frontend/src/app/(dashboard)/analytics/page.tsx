  ...
  if (!data || data.totalSolved === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center">
        <div className="w-16 h-16 rounded-3xl bg-[var(--bg-secondary)] border border-[var(--border-subtle)] flex items-center justify-center text-[var(--text-muted)]">
          <Timer size={32} />
        </div>
        <h2 className="text-xl font-black text-[var(--text-primary)] uppercase font-display">
          No Timing Data Logged Yet
        </h2>
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[var(--accent-primary)] text-black font-bold text-xs hover:scale-[1.02] active:scale-[0.98] transition-all shadow-md font-mono"
        >
          Start Practicing
        </Link>
      </div>
        ...
        <div className="p-5 rounded-3xl bg-[var(--bg-card)] border border-[var(--border-subtle)] flex flex-col justify-between shadow-sm">
          ...
          <div className="mt-4 flex items-baseline gap-2">
            ...
            <span className="text-xs text-[var(--text-muted)] font-medium">
              across {data.totalSolved} solves
            </span>
          </div>
        </div>
