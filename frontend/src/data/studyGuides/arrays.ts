...
export const arraysGuide: StudyGuide = {
  topicName: 'Arrays',
  emoji: '📊',
  tagline: 'The foundation of everything — master arrays and 60% of DSA is done',
...
This pattern appears in: subarray sum equals K, range sum queries, product of array except self.`
  ...
  patternTriggers: [
    ...
    { trigger: 'Subarray of size K or "contiguous"', pattern: 'Sliding Window' },
    { trigger: 'Range sum query or "subarray sum"', pattern: 'Prefix Sum' },
    { trigger: '"In-place" or "O(1) space"', pattern: 'In-place modification with pointers' },
    { trigger: '"Find duplicates" in sorted array', pattern: 'Two pointers or Set' },
    { trigger: '"Rotate array"', pattern: 'Reverse trick: reverse all → reverse parts' },
  ],
  complexityTable: [
