  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between mb-3">
        <div
          className={`p-2 rounded-lg ${isCompleted ? "bg-green-500/20 text-green-400" : "bg-blue-500/20 text-blue-400"}`}
        >
          <BookOpen size={20} />
        </div>
        <div className="text-right">
          ...
          <p
            className={`text-xs font-bold ${isCompleted ? "text-green-400" : "text-blue-400"}`}
          >
