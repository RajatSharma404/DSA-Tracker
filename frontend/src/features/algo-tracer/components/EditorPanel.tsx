...
export function EditorPanel({
  ...
  return (
    <div className="flex flex-col h-full min-h-0 w-full rounded-2xl bg-[#090910] border border-white/10 overflow-hidden shadow-2xl">
      ...
      {/* Monaco Container (fills remaining height, strictly capped) */}
