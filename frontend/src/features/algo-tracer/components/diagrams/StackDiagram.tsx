  ...
  return (
    <div className="flex flex-col h-full w-full justify-between p-2.5 bg-[#0a0a12]/90 rounded-2xl border border-white/5 shadow-xl overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-end py-1 min-h-0">
        <div className="w-36 sm:w-44 border-b-2 border-l-2 border-r-2 border-purple-500/40 rounded-b-xl p-1.5 bg-black/40 flex flex-col-reverse gap-1 max-h-28 overflow-y-auto">
          {stackItems.length > 0 ? (
            ...
            <div className="flex-1 flex items-center justify-center text-[10px] text-gray-600 italic py-2">
              Empty
            </div>
          )}
        </div>
