...
> Auto-generated index of solved DSA problems and patterns.
...
- [**Arrays And Hashing**](./01-arrays-and-hashing/) (33 problems)
...
- [**Dynamic Programming**](./11-dynamic-programming/) (30 problems)
...
| 75 | Sort Colors | Two Pointers / Dutch National Flag | 🟡 Medium | `C++` | `O(n) single pass` | `O(1) in-place` | [Code](./02-two-pointers/0075-sort-colors.cpp) |
...
| 119 | Pascals Triangle Ii | Arrays & Dynamic Programming / Pascal's Triangle | 🟢 Easy | `C++` | `O(rowIndex^2)` | `O(rowIndex) auxiliary space` | [Code](./01-arrays-and-hashing/0119-pascals-triangle-ii.cpp) |
| 120 | Triangle | Dynamic Programming / Bottom-Up Grid DP | 🟡 Medium | `C++` | `O(n^2) where n is number of rows` | `O(n) auxiliary 1D DP array` | [Code](./11-dynamic-programming/0120-triangle.cpp) |
...
| 130 | Surrounded Regions | Graphs / DFS (Matrix Traversal) | 🟡 Medium | `C++` | `O(M * N)` | `O(M * N) recursion stack` | [Code](./10-graphs/0130-surrounded-regions.cpp) |
...
| 160 | Intersection Of Two Linked Lists | Linked List / Two Pointers | 🟢 Easy | `C++` | `O(m + n)` | `O(1)` | [Code](./06-linked-list/0160-intersection-of-two-linked-lists.cpp) |
...
| 236 | Lowest Common Ancestor Of A Binary Tree | Trees & Tries / DFS | 🟡 Medium | `C++` | `O(n)` | `O(h)` | [Code](./07-trees-and-tries/0236-lowest-common-ancestor-of-a-binary-tree.cpp) |
...
| 860 | Lemonade Change | Greedy | 🟢 Easy | `C++` | `O(n)` | `O(1)` | [Code](./12-greedy/0860-lemonade-change.cpp) |
